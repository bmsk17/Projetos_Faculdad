...
template<class T>
No<T>* FilaPrioridades<T>::getFrente(){
    return frente;
}

template<class T>
double FilaPrioridades<T>::busca(int i){
...
template<class T>
void FilaPrioridades<T>::TrocarValor(int i,double valor){
...
template <class T>
void FilaPrioridades<T>::Enfileira(T item){
...
template <class T>
T FilaPrioridades<T>::Desinfileira(){
...
d.executaDijkstra(inicial+1); //aqui quando tu montar tu passa o vertice inicial;
