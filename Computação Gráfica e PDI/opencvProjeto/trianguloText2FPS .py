...
# Cria uma lista de 2 imagens para cada triângulo texturizado
textured_triangles = [np.zeros((100, 100, 3), np.uint8) for _ in range(2)]
...
while True:
    ...
    if elapsed_time == 0:
        ...
        # Desenha e rotaciona os 2 triângulos texturizados
        ...
        combined_img = np.hstack(rotated_textured_triangles)
