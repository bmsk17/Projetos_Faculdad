...
# Cria uma lista de 4 imagens vermelhas para cada triângulo
images = [np.zeros((100, 100, 3), np.uint8) for _ in range(4)]
...
while True:
    ...
    if elapsed_time == 0:
        ...
        # Desenha e rotaciona os 4 triângulos
        ...
        combined_img = np.vstack((np.hstack(rotated_images[:2]), np.hstack(rotated_images[2:])))
