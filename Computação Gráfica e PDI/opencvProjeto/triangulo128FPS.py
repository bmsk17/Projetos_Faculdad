...
# Cria uma lista de 128 imagens para cada triângulo vermelho
red_triangles = [np.zeros((100, 100, 3), np.uint8) for _ in range(128)]
...
while True:
    ...
    if elapsed_time == 0:
        ...
        # Desenha e rotaciona os 128 triângulos vermelhos
        ...
        combined_img = np.vstack(
            [np.hstack(rotated_red_triangles[i:i+16]) for i in range(0, 128, 16)]
        )
